...
export const homeContent = {
  en: {
    ...
    eventsIntro:
      "Find your next creative experience and join us.",
    upcomingEventsTitle: "Upcoming events",
    pastEventsTitle: "Past events",
    pastEventsIntro: "A look back at what we created together.",
    noUpcomingEvents: "New dates are on the way. Register your interest in a future workshop below.",
  ...
  el: {
    ...
    eventsIntro:
      "Βρες την επόμενη δημιουργική σου εμπειρία και έλα στην παρέα μας.",
    upcomingEventsTitle: "Προσεχείς εκδηλώσεις",
    pastEventsTitle: "Προηγούμενες εκδηλώσεις",
    pastEventsIntro: "Μια ματιά σε όσα δημιουργήσαμε μαζί.",
    noUpcomingEvents: "Νέες ημερομηνίες έρχονται σύντομα. Δήλωσε παρακάτω το ενδιαφέρον σου για ένα μελλοντικό εργαστήριο.",

...
const workspaces = [
  { title: "Contacts", description: "Find contact details and the full history of reviews and inquiries in one workspace.", href: "/admin/contacts", action: "View contacts" },
